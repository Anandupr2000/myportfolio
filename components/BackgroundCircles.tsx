...
function BackgroundCircles({ }: Props) {
    return (
        <motion.div
            ...
            <div className='absolute  md:hidden border border-[#333333] rounded-full h-[300px] w-[300px] mt-52'></div>
            <div className='absolute border border-[#333333] rounded-full h-[500px] w-[500px] mt-52 '></div>
            <div className='absolute border border-[#414040] rounded-full h-[500px] w-[500px] mt-52 animate-ping'></div>
